...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/Interactor/ProximityInteractor.swift'
...
public class MockProximityInteractor: ProximityInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any ProximityInteractor
    public typealias Stubbing = __StubbingProxy_ProximityInteractor
    public typealias Verification = __VerificationProxy_ProximityInteractor

    // Original typealiases

    public let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    private var __defaultImplStub: (any ProximityInteractor)?

    public func enableDefaultImplementation(_ stub: any ProximityInteractor) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    public func getSessionStatePublisher() async -> ProximityPublisherPartialState {
        return await cuckoo_manager.call(
            "getSessionStatePublisher() async -> ProximityPublisherPartialState",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    public func getCoordinator() async -> ProximityCoordinatorPartialState {
        return await cuckoo_manager.call(
            "getCoordinator() async -> ProximityCoordinatorPartialState",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    public func onQRGeneration() async -> ProximityQrCodePartialState {
        return await cuckoo_manager.call(
            "onQRGeneration() async -> ProximityQrCodePartialState",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.onQRGeneration()
        )
    }
    ...
    public func onSendResponse() async -> ProximityResponsePartialState {
        return await cuckoo_manager.call(
            "onSendResponse() async -> ProximityResponsePartialState",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
    ...
    public struct __StubbingProxy_ProximityInteractor: Cuckoo.StubbingProxy {
        ...
        func getSessionStatePublisher() -> Cuckoo.ProtocolStubFunction<(), ProximityPublisherPartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockProximityInteractor.self,
                method: "getSessionStatePublisher() async -> ProximityPublisherPartialState",
                parameterMatchers: matchers
            ))
        }
        
        func getCoordinator() -> Cuckoo.ProtocolStubFunction<(), ProximityCoordinatorPartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockProximityInteractor.self,
                method: "getCoordinator() async -> ProximityCoordinatorPartialState",
                parameterMatchers: matchers
            ))
        }
        ...
        func onQRGeneration() -> Cuckoo.ProtocolStubFunction<(), ProximityQrCodePartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockProximityInteractor.self,
                method: "onQRGeneration() async -> ProximityQrCodePartialState",
                parameterMatchers: matchers
            ))
        }
        ...
        func onSendResponse() -> Cuckoo.ProtocolStubFunction<(), ProximityResponsePartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockProximityInteractor.self,
                method: "onSendResponse() async -> ProximityResponsePartialState",
                parameterMatchers: matchers
            ))
        }
    ...
    public struct __VerificationProxy_ProximityInteractor: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
        ...
        @discardableResult
        func getSessionStatePublisher() -> Cuckoo.__DoNotUse<(), ProximityPublisherPartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
                "getSessionStatePublisher() async -> ProximityPublisherPartialState",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func getCoordinator() -> Cuckoo.__DoNotUse<(), ProximityCoordinatorPartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
                "getCoordinator() async -> ProximityCoordinatorPartialState",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func onQRGeneration() -> Cuckoo.__DoNotUse<(), ProximityQrCodePartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
                "onQRGeneration() async -> ProximityQrCodePartialState",
                callMatcher: callMatcher,
        ...
        @discardableResult
        func onSendResponse() -> Cuckoo.__DoNotUse<(), ProximityResponsePartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
                "onSendResponse() async -> ProximityResponsePartialState",
                callMatcher: callMatcher,
...
public class ProximityInteractorStub:ProximityInteractor, @unchecked Sendable {


    
    public func getSessionStatePublisher() async -> ProximityPublisherPartialState {
        return DefaultValueRegistry.defaultValue(for: (ProximityPublisherPartialState).self)
    }
...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/UI/Connectivity/ProximityConnectionView.swift'
...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/UI/Connectivity/ProximityConnectionViewModel.swift'
...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/UI/Presentation/Loading/ProximityLoadingView.swift'
...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/UI/Presentation/Request/ProximityRequestView.swift'
...
// MARK: - Mocks generated from file: '../Modules/feature-proximity/Sources/UI/Presentation/Success/ProximitySuccessView.swift'
