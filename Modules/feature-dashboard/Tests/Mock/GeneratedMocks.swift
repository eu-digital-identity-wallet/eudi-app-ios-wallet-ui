...
public class MockDashboardInteractor: DashboardInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any DashboardInteractor
    ...
    public func getWalletKitController() async -> WalletKitController {
        return await cuckoo_manager.call(
            "getWalletKitController() async -> WalletKitController",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.getWalletKitController()
        )
    }
    ...
    public struct __StubbingProxy_DashboardInteractor: Cuckoo.StubbingProxy {
        ...
        func getWalletKitController() -> Cuckoo.ProtocolStubFunction<(), WalletKitController> {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockDashboardInteractor.self,
                method: "getWalletKitController() async -> WalletKitController",
                parameterMatchers: matchers
            ))
        }
    }
...
public class MockDocumentTabInteractor: DocumentTabInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any DocumentTabInteractor
    ...
    public func hasDeferredDocuments() async -> Bool {
        return await cuckoo_manager.call(
            "hasDeferredDocuments() async -> Bool",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.hasDeferredDocuments()
        )
    }
    ...
    public func onFilterChangeState() async -> AsyncStream<DocumentFiltersPartialState> {
        return await cuckoo_manager.call(
            ...
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.onFilterChangeState()
        )
    }
    ...
    public struct __StubbingProxy_DocumentTabInteractor: Cuckoo.StubbingProxy {
        ...
        func hasDeferredDocuments() -> Cuckoo.ProtocolStubFunction<(), Bool> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockDocumentTabInteractor.self,
                method: "hasDeferredDocuments() async -> Bool",
                parameterMatchers: matchers
            ))
        }
        ...
        func onFilterChangeState() -> Cuckoo.ProtocolStubFunction<(), AsyncStream<DocumentFiltersPartialState>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockDocumentTabInteractor.self,
                method: "onFilterChangeState() async -> AsyncStream<DocumentFiltersPartialState>",
                parameterMatchers: matchers
            ))
        }
...
public class MockHomeTabInteractor: HomeTabInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any HomeTabInteractor
    ...
    public func fetchUsername() async -> String {
        return await cuckoo_manager.call(
            "fetchUsername() async -> String",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.fetchUsername()
        )
    }
    ...
    public func openBleSettings() async {
        return await cuckoo_manager.call(
            "openBleSettings() async",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.openBleSettings()
        )
    }
    ...
    public struct __StubbingProxy_HomeTabInteractor: Cuckoo.StubbingProxy {
        ...
        func fetchUsername() -> Cuckoo.ProtocolStubFunction<(), String> {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockHomeTabInteractor.self,
                method: "fetchUsername() async -> String",
                parameterMatchers: matchers
            ))
        }
...
public class MockTransactionTabInteractor: TransactionTabInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any TransactionTabInteractor
    ...
    public func onFilterChangeState() async -> AsyncStream<TransactionFiltersPartialState> {
        return await cuckoo_manager.call(
            "onFilterChangeState() async -> AsyncStream<TransactionFiltersPartialState>",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.onFilterChangeState()
    ...
    public struct __StubbingProxy_TransactionTabInteractor: Cuckoo.StubbingProxy {
        ...
        func fetchTransactions() -> Cuckoo.ProtocolStubThrowingFunction<(), TransactionsPartialState,Swift.Error> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        func onFilterChangeState() -> Cuckoo.ProtocolStubFunction<(), AsyncStream<TransactionFiltersPartialState>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockTransactionTabInteractor.self,
                method: "onFilterChangeState() async -> AsyncStream<TransactionFiltersPartialState>",
                parameterMatchers: matchers
            ))
        }
...
public class MockDocumentDetailsInteractor: DocumentDetailsInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any DocumentDetailsInteractor
    ...
    public func reIssueDocument(identifier p0: String) async -> DocumentDetailsReIssuancePartialState {
        return await cuckoo_manager.call(
            "reIssueDocument(identifier p0: String) async -> DocumentDetailsReIssuancePartialState",
            parameters: (p0),
            escapingParameters: (p0),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
            defaultCall: await __defaultImplStub!.reIssueDocument(identifier: p0)
        )
    }
    ...
    public struct __StubbingProxy_DocumentDetailsInteractor: Cuckoo.StubbingProxy {
        ...
        func reIssueDocument<M1: Cuckoo.Matchable>(identifier p0: M1) -> Cuckoo.ProtocolStubFunction<(String), DocumentDetailsReIssuancePartialState> where M1.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockDocumentDetailsInteractor.self,
                method: "reIssueDocument(identifier p0: String) async -> DocumentDetailsReIssuancePartialState",
                parameterMatchers: matchers
            ))
        }
        ...
        func save<M1: Cuckoo.Matchable>(_ p0: M1) -> Cuckoo.ProtocolStubNoReturnThrowingFunction<(String),Swift.Error> where M1.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockDocumentDetailsInteractor.self,
        ...
        func delete<M1: Cuckoo.Matchable>(_ p0: M1) -> Cuckoo.ProtocolStubNoReturnThrowingFunction<(String),Swift.Error> where M1.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: p0) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockDocumentDetailsInteractor.self,
    ...
    public struct __VerificationProxy_DocumentDetailsInteractor: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func reIssueDocument<M1: Cuckoo.Matchable>(identifier p0: M1) -> Cuckoo.__DoNotUse<(String), DocumentDetailsReIssuancePartialState> where M1.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: p0) { $0 }]
            return cuckoo_manager.verify(
                "reIssueDocument(identifier p0: String) async -> DocumentDetailsReIssuancePartialState",
                callMatcher: callMatcher,
...
public class DocumentDetailsInteractorStub:DocumentDetailsInteractor, @unchecked Sendable {
    ...
    public func reIssueDocument(identifier p0: String) async -> DocumentDetailsReIssuancePartialState {
        return DefaultValueRegistry.defaultValue(for: (DocumentDetailsReIssuancePartialState).self)
    }
...
public class MockTransactionDetailsInteractor: TransactionDetailsInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any TransactionDetailsInteractor
...
public class MockDocumentSignInteractor: DocumentSignInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any DocumentSignInteractor
...
public class MockSettingsInteractor: SettingsInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
    public typealias MocksType = any SettingsInteractor
    ...
    public func retrieveChangeLogUrl() async -> URL? {
        return await cuckoo_manager.call(
            "retrieveChangeLogUrl() async -> URL?",
            parameters: (),
            escapingParameters: (),
            superclassCall: Cuckoo.MockManager.crashOnProtocolSuperclassCall(),
...
// MARK: - Mocks generated from file: '../Modules/feature-dashboard/Sources/UI/Accessibility/DocumentDetailsLocators.swift'
...
// MARK: - Mocks generated from file: '../Modules/feature-dashboard/Sources/UI/Accessibility/IssuanceOptionLocators.swift'
