...
public class MockFAQsInteractor: FAQsInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
...
public class FAQsInteractorStub:FAQsInteractor, @unchecked Sendable {
...
public class MockWelcomeInteractor: WelcomeInteractor, Cuckoo.ProtocolMock, @unchecked Sendable {
...
public class WelcomeInteractorStub:WelcomeInteractor, @unchecked Sendable {
