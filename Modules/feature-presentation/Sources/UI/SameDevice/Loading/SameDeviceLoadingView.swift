...
public struct SameDeviceLoadingView<Router: RouterHostType, Interactor: OnlinePresentationInteractorType>: View {

  @ObservedObject private var viewModel: SameDeviceLoadingViewModel<Router, Interactor>
