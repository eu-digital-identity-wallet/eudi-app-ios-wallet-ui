...
public struct FilterIds {
  ...
  public static let FILTER_BY_STATUS_COMPLETED = "status_completed"
  public static let FILTER_BY_START_DATE = "start_date"
  public static let FILTER_BY_END_DATE = "end_date"
