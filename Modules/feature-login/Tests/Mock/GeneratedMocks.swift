...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/Interactor/FAQsInteractor.swift'
...
public class MockFAQsInteractor: FAQsInteractor, Cuckoo.ProtocolMock {
    public typealias MocksType = FAQsInteractor
    public typealias Stubbing = __StubbingProxy_FAQsInteractor
    public typealias Verification = __VerificationProxy_FAQsInteractor

    // Original typealiases

    public let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    private var __defaultImplStub: (any FAQsInteractor)?

    public func enableDefaultImplementation(_ stub: any FAQsInteractor) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    public struct __StubbingProxy_FAQsInteractor: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        ...
        func fetchFAQs() -> Cuckoo.ProtocolStubFunction<(), FAQsPartialState> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockFAQsInteractor.self,
                method: "fetchFAQs() async -> FAQsPartialState",
                parameterMatchers: matchers
            ))
        }
    }

    public struct __VerificationProxy_FAQsInteractor: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
...
public class FAQsInteractorStub:FAQsInteractor {
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/Interactor/WelcomeInteractor.swift'
...
public class MockWelcomeInteractor: WelcomeInteractor, Cuckoo.ProtocolMock {
    public typealias MocksType = WelcomeInteractor
    public typealias Stubbing = __StubbingProxy_WelcomeInteractor
    public typealias Verification = __VerificationProxy_WelcomeInteractor

    // Original typealiases

    public let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    private var __defaultImplStub: (any WelcomeInteractor)?

    public func enableDefaultImplementation(_ stub: any WelcomeInteractor) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }


    public struct __StubbingProxy_WelcomeInteractor: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
    ...
    public struct __VerificationProxy_WelcomeInteractor: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
...
public class WelcomeInteractorStub:WelcomeInteractor {
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/FAQs/FAQsView.swift'
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/FAQs/FAQsViewModel.swift'
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/FAQs/Model/FAQUIModel.swift'
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/Welcome/Accesibility/WelcomeLocators.swift'
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/Welcome/WelcomeView.swift'
...
// MARK: - Mocks generated from file: 'Modules/feature-login/Sources/UI/Welcome/WelcomeViewModel.swift'
