...
@MainActor
final class PresentationRequestViewModel<Router: RouterHostType, Interactor: PresentationInteractorType>: BaseViewModel<Router, AuthRequestViewState> {
        ...
        .biometry(
          config: UIConfig.Biometry(
            ...
            navigationSuccessConfig: .init(
              screen: .presentationLoader(viewState.relyingParty),
              navigationType: .push
            ),
